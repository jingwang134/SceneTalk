...
function openAiSettings(){
  ...
  document.getElementById('aiEndpoint').value=cfg.endpoint||'https://api.deepseek.com/chat/completions';
...
function saveAiSettings(){
  ...
  saveAiCfg({key:key, endpoint:endpoint||'https://api.deepseek.com/chat/completions', model:model||'deepseek-chat'});
  closeAiSettings();
  showToast('✅ AI Key 已保存（仅存本浏览器）');
}
