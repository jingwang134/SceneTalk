...
//   每维度 = angle（切入引导话术："谈XX时，可以这么说"，给用户多种说法，不宣称唯一）
//          + items（紧贴该维度的语料，三级递进：phrase 短语 → sentence 台本真实单句 → clip 完整观点片段）
//          + use（支架句：怎么把该维度组织进 Part 2/3 回答）
// 铁律：
//   1. items 语义必须紧贴 angle——语料服务维度，禁止"角度归角度、语料归语料"
//   2. 每维度至少 1 条 sentence/clip 级语料（真实台本原句，AI 不得虚构台词）
//   3. 每条语料标注真实来源（剧名 + 集数）
//   4. angle 禁止出现"母语者/思维框架"等措辞——只是剧本里提炼的同场景表达，多多益善
const TOPIC_PERSPECTIVES = {
  family: {
    map: "聊「家庭」，可以从这 3 个维度展开",
    dimensions: [
      {
        tag: "维度①",
        name: "家人各有闪光点，不互相比较",
        angle: "谈家人时，可以夸\"每个人闪光的方式不一样\"，下面的说法都能用上。",
        items: [
      ...
      },
      {
        tag: "维度②",
        name: "关键时刻，家人互相支撑",
        angle: "谈家人时，可以聊\"关键时刻谁靠得住\"，count on 就是现成的说法。",
        items: [
      ...
      },
      {
        ...
        angle: "谈家人时，可以聊\"接纳不完美\"——先承认家里有缺点，再说依然有爱。",
        items: [
  ...
  work: {
    map: "聊「工作职业」，可以从这 3 个维度展开",
    dimensions: [
      {
        tag: "维度①",
        name: "择业动机：能力匹配 vs 内心热爱",
        angle: "谈工作选择时，可以聊\"能不能胜任\"和\"喜不喜欢\"这两方面，下面给你几种说法。",
        items: [
      ...
      },
      {
        ...
        angle: "谈职场成败时，可以聊\"坚持\"：follow through、drop the ball、back to square one 都是这个场景的说法。",
        items: [
      ...
      },
      {
        ...
        angle: "谈谈判说服时，可以这么组织：先亮底线，再留余地——下面是配套的说法。",
        items: [
  ...
  communication: {
    map: "聊「沟通社交」，可以从这 3 个维度展开",
    dimensions: [
      {
        tag: "维度①",
        name: "先观察再开口：读懂言外之意",
        angle: "谈沟通时，可以说\"要听懂言外之意\"，read between the lines 就是常用说法。",
        items: [
      ...
      },
      {
        tag: "维度②",
        name: "冲突处理：说开 vs 回避",
        angle: "谈矛盾时，有两条路：把话说开，或者回避问题——两条路都给你现成的说法。",
        items: [
      ...
      },
      {
        tag: "维度③",
        name: "真诚是关系升级的基础",
        angle: "谈关系更进一步时，可以说\"先做真实的自己\"，keep it real 就是常用说法。",
        items: [
  ...
  values: {
    map: "聊「价值观」，可以从这 3 个维度展开",
    dimensions: [
      {
        tag: "维度①",
        name: "原则 vs 方便：底线不能折价",
        angle: "谈原则时，可以用\"不是X，而是Y\"的句式亮明底线——比直接说\"不\"更有力。",
        items: [
      ...
      },
      {
        tag: "维度②",
        name: "诚信：说到做到 > 说得好听",
        angle: "谈诚信时，可以聊\"说到做到\"，make a commitment 这类说法都用得上。",
        items: [
      ...
      },
      {
        tag: "维度③",
        name: "敢表态，但不越界",
        angle: "谈分寸时，可以说\"该强硬时强硬，但不越界\"，put your foot down 就是现成的。",
        items: [
  ...
  education: {
    map: "聊「教育成长」，可以从这 3 个维度展开",
    dimensions: [
      {
        tag: "维度①",
        name: "天赋 vs 努力：聪明不止一种",
        angle: "谈学习时，可以聊\"聪明不止一种\"，book smart / street smart 就是现成说法。",
        items: [
      ...
      },
      {
        tag: "维度②",
        name: "尊重节奏：不强行改造孩子",
        angle: "谈教育方式时，可以说\"给孩子空间自己找路\"，下面这段就是很好的示范。",
        items: [
      ...
      },
      {
        tag: "维度③",
        name: "保护好奇心：求知欲是燃料",
        angle: "谈学习动力时，可以说\"求知欲\"，a thirst for knowledge 就是常用搭配。",
        items: [
  ...
  skills: {
    map: "聊「技能能力」，可以从这 3 个维度展开",
    dimensions: [
      {
        tag: "维度①",
        name: "技能来自刻意练习，不是天赋",
        angle: "谈技能怎么练成时，可以聊\"练出来的\"——\"一万小时\"的说法就用上了。",
        items: [
      ...
      },
      {
        tag: "维度②",
        name: "技能的价值：关键时刻能拿结果",
        angle: "谈技能的价值时，可以说\"关键时刻能拍板\"，make a judgment call 就是现成说法。",
        items: [
      ...
      },
      {
        tag: "维度③",
        name: "用自己的方式达成目标",
        angle: "谈做事方法时，可以说\"有自己的路子\"——自己命名一套方法，也是展示能力的方式。",
        items: [
  ...
  friendship: {
    map: "聊「友谊」，可以从这 3 个维度展开",
    dimensions: [
      {
        tag: "维度①",
        name: "关键时刻靠得住",
        angle: "谈朋友时，可以聊\"关键时刻靠得住\"，count on 就是常用说法。",
        items: [
          { type: "phrase", en: "count on someone", zh: "指望某人，信赖某人", source: "摩登家庭 S01E04" },
      ...
      },
      {
        tag: "维度②",
        name: "一起经历过，信任自然沉淀",
        angle: "谈友谊深度时，可以讲\"一起经历的事\"——长谈、争吵、和好，都是现成的素材。",
        items: [
      ...
      },
      {
        tag: "维度③",
        name: "能做真实的自己",
        angle: "谈真朋友时，可以说\"在他面前能做自己\"，no inhibitions 就是现成说法。",
        items: [
  ...
  media: {
    map: "聊「媒体社会」，可以从这 3 个维度展开",
    dimensions: [
      {
        tag: "维度①",
        name: "表象 vs 真相：看到的未必是真的",
        angle: "谈媒体信息时，可以说\"看到的只是冰山一角\"，秘密迟早会泄露出来。",
        items: [
      ...
      },
      {
        tag: "维度②",
        name: "压抑的东西迟早爆发",
        angle: "谈网络情绪时，可以说\"压着不说，迟早爆发\"，bubble up 就是现成说法。",
        items: [
      ...
      },
      {
        tag: "维度③",
        name: "信息过载时代，抓重点的能力",
        angle: "谈信息过载时，可以说\"直接说重点\"，cut to the chase 就是常用说法。",
        items: [
